/**
 * Created by sadegh on 1/5/17.
 */
$(document).on({
    ajaxStart: function() { document.body.className = "loading";console.log('start');},
     ajaxStop: function() { document.body.className = '';console.log('end');}
});
