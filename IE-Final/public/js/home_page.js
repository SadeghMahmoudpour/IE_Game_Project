...
(function () {
    $.ajax({
        type: "GET",
        url: "http://localhost:8000/api/home.xml",
        dataType: "xml",
    ...
    function addMainSlider(title, abstract, large_image) {
        ...
        loginButton.setAttribute('href', 'game_page?game_title=' + title);
        loginButton.innerHTML = 'ورود به <b>صفحه‌ی</b> بازی';
        loginButton.className = 'btn-primary';

        // var trailerLink = document.createElement('a');
        // trailerLink.setAttribute('href', 'game_page?game_title=' + title + '&tab=4');
    ...
    function addSmallSlider(title, number_of_comments, small_image) {
        ...
        gameLink.setAttribute('href', 'game_page?game_title=' + title);
    ...
    function addComment(comment) {
        ...
        commentCard.setAttribute('href', 'game_page?game_title=' + comment.getElementsByTagName('game')[0].getElementsByTagName('title')[0].childNodes[0].nodeValue + '&tab=2')
    ...
    function addTutorial(tutorial) {
        ...
        tutorCard.setAttribute('href', 'game_page?game_title=' + tutorial.getElementsByTagName('game')[0].getElementsByTagName('title')[0].childNodes[0].nodeValue + '&tab=0')
